...
const TechnicalExpertise = () => {
  return (
    <section className="px-[max(20px,13.542vw)] pb-[max(50px,5.208vw)] text-center">
      <h2 className="mb-[max(35px,3.125vw)] text-[max(30px,2.396vw)] font-bold text-dark-blue">
      ...
      <div className="space-y-[max(10px,0.833vw)]">
        {salesforce_developers.map((data) => (
          <div className="grid grid-cols-12">
            <div className="col-span-3 flex items-center justify-center bg-green-blue p-3">
      ...
      <ButtonLink additionalClasses="bg-green">
